...
$arrDca['palettes']['iso_productreader'] = str_replace(
    'iso_buttons;',
    'iso_buttons;{bookings_legend},bp_months;',
...
$arrDca['palettes']['iso_product_frontend_creator'] = '{title_legend},name,headline,type;'
                                                      ...
                                                      . '{product_legend},iso_productType,iso_productCategory,iso_exifMapping,formHybridAddDefaultValues;'
...
$arrDca['palettes']['iso_product_frontend_editor'] = '{title_legend},name,headline,type;'
                                                     . '{entity_legend},formHybridDataContainer,formHybridEditable,formHybridAddEditableRequired,formHybridAddReadOnly,formHybridAddPermanentFields;'
                                                     . '{action_legend},formHybridAllowIdAsGetParameter,noIdBehavior,disableSessionCheck,disableAuthorCheck,addUpdateConditions,allowDelete,formHybridAsync,deactivateTokens;'
                                                     . '{misc_legend},formHybridSuccessMessage,formHybridSkipScrollingToSuccessMessage,formHybridCustomSubmit,formHybridAddDefaultValues,setPageTitle,addClientsideValidation;'
                                                     . '{template_legend},formHybridTemplate,modalTpl,customTpl;'
                                                     . '{protected_legend:hide},protected;{expert_legend:hide},guests,cssID,space';
 ...
 * Fields
 */
$arrDca['fields']['iso_productType'] = array(
...
$arrDca['fields']['iso_productCategory'] = array(
    'label'      => &$GLOBALS['TL_LANG']['tl_module']['iso_productCategory'],
    'inputType'  => 'pageTree',
    'foreignKey' => 'tl_page.title',
    'eval'       => array('multiple' => true, 'mandatory' => true, 'fieldType' => 'checkbox', 'includeBlankOption' => true, 'tl_class' => 'clr'),
    'relation'   => array('type' => 'hasMany', 'load' => 'lazy'),
    'sql'        => "text NULL",
);

$arrDca['fields']['iso_exifMapping'] = array(
        ...
        'multiColumnEditor' => array(
            ...
            'fields'      => array(
                'exifTag'    => array(
                    ...
                    'inputType'        => 'select',
                    'options_callback' => array('HeimrichHannot\Haste\Image\Image', 'getExifTagsAsOptions'),
                    'eval'             => array('chosen' => true, 'mandatory' => true, 'style' => 'width:200px', 'includeBlankOption' => true),
                ),
                'customTag'  => array(
                    'label'     => &$GLOBALS['TL_LANG']['tl_module']['iso_exifMapping']['iso_exifMapping_customTag'],
                    'inputType' => 'text',
                    'eval'      => array('maxLength' => 100, 'style' => 'width:200px'),
                ),
                'tableField' => array(
                    'label'            => &$GLOBALS['TL_LANG']['tl_module']['iso_exifMapping']['iso_exifMapping_tableField'],
                    'inputType'        => 'select',
                    'options_callback' => array('HeimrichHannot\IsotopePlus\Callbacks', 'getProductTableFieldsAsOptions'),
                    'eval'             => array('chosen' => true, 'mandatory' => true, 'style' => 'width:300px', 'includeBlankOption' => true),
                ),
            ),
        ),
    ),
        ...
        switch ($objModule->type)
        {
            ...
            case 'iso_product_frontend_creator' :
                $arrDca['fields']['formHybridDefaultValues']['eval']['columnFields']['field']['options_callback'] =
                    array('HeimrichHannot\IsotopePlus\Callbacks', 'getDefaultValueFields');
        }
    }
