...
$GLOBALS['TL_LANG']['tl_iso_config']['stockDecreaseOrderStates'] = array('Bestandsverringernde Bestellstatus (nur Backend)', 'Wählen Sie hier die Status aus, deren Aktivierung zu einer Verringerung des Status führen. Diese Einstellung wird nur im Backend ausgewertet. ACHTUNG: Diese Option muss in allen Shop-Konfigurationen gesetzt werden, die mit einer relevanten Bestellung verknüpft sind.');
