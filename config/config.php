...
$GLOBALS['ISO_HOOKS']['addProductToCollection']['validateStockCollectionAdd']    =
    array('HeimrichHannot\IsotopePlus\IsotopePlus', 'validateStockCollectionAdd');
$GLOBALS['ISO_HOOKS']['preCheckout']['validateStockCheckout']                    = array('HeimrichHannot\IsotopePlus\IsotopePlus', 'validateStockPreCheckout');
$GLOBALS['ISO_HOOKS']['postCheckout']['validateStockCheckout']                   = array('HeimrichHannot\IsotopePlus\IsotopePlus', 'validateStockPostCheckout');
...
$GLOBALS['ISO_HOOKS']['updateItemInCollection']['validateStockCollectionUpdate'] =
    array('HeimrichHannot\IsotopePlus\IsotopePlus', 'validateStockCollectionUpdate');
$GLOBALS['ISO_HOOKS']['buttons'][]                                               =
    array('HeimrichHannot\IsotopePlus\IsotopePlus', 'addDownloadSingleProductButton');
...
$GLOBALS['TL_HOOKS']['postUpload'][]               = array('HeimrichHannot\IsotopePlus\Callbacks', 'createProductsFromBackendUpload');
...
$GLOBALS['FE_MOD']['isotopeplus'] = array(
    ...
    'iso_product_frontend_creator' => 'Isotope\Module\ProductFrontendCreator',
);
...
if (TL_MODE == 'FE')
{
    $GLOBALS['TL_MODELS']['tl_iso_product']         = 'Isotope\Model\CreatorProduct';
    $GLOBALS['TL_MODELS']['tl_iso_product_creator'] = 'Isotope\Model\ProductCreator';
}
